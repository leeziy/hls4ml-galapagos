#ifndef CNN_BRIDGE_H_
#define CNN_BRIDGE_H_
...
void CNN_float(
    ...
    hls::stream<result_t> layer27_out_ap("layer27_out");

    CNN(input_1_ap,layer27_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_25>(layer27_out_ap, layer27_out);
}

void CNN_double(
    double input_1[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1],
    double layer27_out[N_LAYER_25]
) {
    hls::stream<input_t> input_1_ap("input_1");
    ...
    nnet::convert_data<result_t, double, N_LAYER_25>(layer27_out_ap, layer27_out);
}
}
