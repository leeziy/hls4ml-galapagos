...
set_top CNN
add_files firmware/Galapagos_Kernel_1.cpp -cflags "-std=c++0x"
add_files firmware/Galapagos_Kernel_2.cpp -cflags "-std=c++0x"
add_files firmware/Galapagos_Kernel_3.cpp -cflags "-std=c++0x"
...
add_files -tb Galapagos_CNN_test.cpp -cflags "-std=c++0x -Wno-unknown-pragmas"
